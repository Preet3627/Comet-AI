...
*   **Electron**: MIT License
    *   Electron itself is MIT licensed, but it bundles Chromium, which is a complex open-source project that incorporates code from numerous other projects, each with its own licensing terms (e.g., BSD, MIT, Apache, LGPL, etc.). For a comprehensive list of Chromium's third-party notices, please refer to the Chromium source code documentation or the about page of any Chromium-based browser.
*   **Next.js**: MIT License

## Application Dependencies

*   **@ghostery/adblocker-electron**: Mozilla Public License 2.0 (MPL-2.0)
*   **@tensorflow/tfjs**: Apache License 2.0
*   **cross-fetch**: MIT License
*   **electron-context-menu**: MIT License
*   **firebase**: Apache License 2.0 (for SDKs, usage governed by Google Cloud Platform Terms)
...
*   **react-pdftotext**: MIT License
*   **tesseract.js**: Apache License 2.0
*   **zustand**: MIT License
*   **react-markdown**: MIT License
*   **remark-gfm**: MIT License
*   **rehype-katex**: MIT License
*   **remark-math**: MIT License
*   **katex**: MIT License
*   **react-pdf**: MIT License

## Development Dependencies

*   **@eslint/compat**: MIT License (part of ESLint)
*   **@next/eslint-plugin-next**: MIT License (part of Next.js)
*   **@tailwindcss/postcss**: MIT License
